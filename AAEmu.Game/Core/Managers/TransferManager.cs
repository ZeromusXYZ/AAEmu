...
public class TransferManager
{
    ...
    public Transfer Create(WorldInstance parentWorld, uint objectId, uint templateId, TransferSpawner spawner)
    {
        ...
        */
        ...
        transfer.Transform.Local.SetHeight(transfer.ParentWorld.GetHeight(transfer.Transform.World.Position)); // WorldManager.Instance.GetHeight(transfer.Transform)));
