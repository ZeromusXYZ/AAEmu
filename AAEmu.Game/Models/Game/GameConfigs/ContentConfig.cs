...
/*
    ...
    1	labor_power_per_tick
    2	labor_power_tick
    3	duel_distance
    4	duel_wait_response
    6	limited_max_labor_power
    8	max_specialty_price_ratio
    9	min_specialty_price_ratio
    10	max_sim_count
    11	auction_charge
    12	auction_deposit_6
    13	auction_deposit_12
    14	auction_deposit_24
    15	auction_deposit_48
    16	quest_let_it_done
    17	quest_over_done
    18	adjust_ratio_per_trade
    20	regulate_down_time
    23	actability_min_dice_ratio
    25	lp_start
    26	lp_max
    27	lp_up_consume
    28	lp_up_value
    29	pcbang_speedup
    31	daily_limit
    37  base house sale price? (is 100g in 1.2)
    38	reset_ability
    39	change_ability
    40	auction_deposit_max
    41	inventory_expansion_max_size
    42	bank_expansion_max_size
    43	item_secure_unlock_delay_time
    45	faction_diplomacy_request_count
    46	faction_diplomacy_deny_count
    47	beautyshop_use_item_kind
    50	faction_delete_delay
    51	faction_diplomacy_history_size
    52	genderTransfer_use_item_kind
    53	genderTransfer_use_item_count
    57	sell_house_seal_type
    59	ratio_mod
    60	seller_share_ratio
    61	tax_gold_ratio
    62	socketing_level_limit
    63	pcbang
    64	mail_cool_time
