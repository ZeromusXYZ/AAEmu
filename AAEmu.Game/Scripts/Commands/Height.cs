...
public class Height : ICommand
{
    ...
    public void Execute(Character character, string[] args, IMessageOutput messageOutput)
    {
        ...
        var floorHeight = targetPlayer.ParentWorld.GetHeight(targetPlayer.Transform.World.Position);
        var navMeshHeight = targetPlayer.ParentWorld.GetHeight(targetPlayer.Transform.World.Position); // WorldManager.Instance.GetHeight(targetPlayer.Transform.ZoneId, targetPlayer.Transform.World.Position.X, targetPlayer.Transform.World.Position.Y, targetPlayer.Transform.World.Position.Z);
